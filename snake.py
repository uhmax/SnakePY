...
pygame.display.set_caption('Totally Not Snake')
    ...
    for y in range(0, int(GRID_HEIGHT)):
        for x in range(0, int(GRID_WIDTH)):
            if (x + y) % 2 == 0:
                ...
                pygame.draw.rect(surface, (255, 255, 255), r) # Change grid colour
            else:
                rr = pygame.Rect((x * GRIDSIZE, y * GRIDSIZE), (GRIDSIZE, GRIDSIZE))
                pygame.draw.rect(surface, (255, 255, 255), rr) # Change grid colour
